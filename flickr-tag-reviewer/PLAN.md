...
> If instead you meant Flickr's _people-in-photo_ notes (`flickr.photos.people.add`,
...
- cos/res metadata refreshed. You get a summary: _N new, M unchanged, K already-reviewed_.
